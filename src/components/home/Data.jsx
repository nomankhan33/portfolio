...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Hi, I'm Mohd Noman Khan
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm a 4th-year Computer Science Engineering student at Jamia Millia Islamia with a keen interest in AI/ML and Web Development.</p>
